...
## 七码小说推文1.0.3更新说明
* 1、任务管理新增项目记录快捷按钮
* 2、任务管理添加任务时可自定义配置图片信息
* 3、项目管理支持多图选择
* 4、项目管理优化了编辑页面
* 5、系统配置添加了参数配置说明
* 6、任务管理添加任务时可自定义选择配音、视频动画
## 七码小说推文更新说明
* 1、新增了剪映草稿关键帧：缩小、放大、上下移动、左右移动
* 2、新增了阿里云语音appkey配置项
* 3、新增了gpt api地址可后台自行配置
* 4、新增了任务配置可以自定义每个任务的时间
## 七码小说推文安装说明
* 设置运行目录为public
* 导入数据库文件
* 修改application/database.php下database、username、password
* 访问域名+"/PnIztHheRL.php"可自行修改
* 默认账号：admin 密码123qaz123
* 若使用中转平台URL要填写完整，平台地址+/v1/chat/completions
